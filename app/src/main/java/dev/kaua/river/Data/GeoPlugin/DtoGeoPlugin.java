package dev.kaua.river.Data.GeoPlugin;

public class DtoGeoPlugin {
    private String geoplugin_request, geoplugin_status, geoplugin_delay, geoplugin_city, geoplugin_regionCode, geoplugin_countryName;
